    ...
    <table class="table table-striped">
        ...
        <c:forEach var="user" items="${users}">
            ...
            <tr>
                ...
                <td><a href="/users/edit/${user.id}"><spring:message code="user.table.update"/></a></td>
                <td><a href="/users/delete/${user.id}"><spring:message code="user.table.delete"/></a></td>
            </tr>
        </c:forEach>
    </table>
    <hr/>
    <a class="btn btn-primary btn-mini" href="/users/add" role="button">
        <spring:message code="user.table.add_user"/>
    </a>
    <a class="btn btn-primary btn-mini" href="/orders/all" role="button">
