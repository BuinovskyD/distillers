...
<div class="container">
    ...
    <sec:authorize access="hasAuthority('ADMIN')">
        <a class="btn btn-primary btn-lg" href="${pageContext.request.contextPath}/users" role="button">
            <spring:message code="app.admin_panel_btn"/>
        </a>
    </sec:authorize>
    <a class="btn btn-primary btn-lg" href="${pageContext.request.contextPath}/orders" role="button">
